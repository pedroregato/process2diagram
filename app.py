...
pages = {
    ...
    "Ajuda": [
        ...
        st.Page("pages/Orientacoes_Assistente.py",   title="Ferramentas do Assistente", icon="🛠️"),
    ...
    "Guias": [
        ...
        st.Page("pages/Orientacoes_CacheSemantico.py", title="Cache LLM",   icon="💾"),
...
if _admin:
    pages["Manutenção"] = [
        ...
        st.Page("pages/MinutesBackfill.py",         title="Minutes Backfill",       icon="🗒️"),
        st.Page("pages/RequirementsBackfill.py",    title="Requirements Backfill",  icon="📋"),
        st.Page("pages/DmnBackfill.py",             title="DMN Backfill",           icon="⚖️"),
        st.Page("pages/IbisBackfill.py",            title="IBIS Backfill",          icon="🧵"),
