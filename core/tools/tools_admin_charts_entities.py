            ...
            },
            {
                ...
                "function": {
                    ...
                    "description": (
                        ...
                        "Útil para reuniões processadas com 'Gerar Provocações' desativado (padrão "
                        "até o PC205, ligado por padrão desde então) — as contradições já existiam, "
                        "só nunca tinham sido convertidas em provocação. NÃO cobre absence/asymmetry/premise (essas exigem "
