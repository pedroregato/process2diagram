...
<div class="g-card" style="background:linear-gradient(135deg,#071428 0%,#0B1F3A 50%,#0D1F38 100%);">
  ...
  <div style="margin-top:28px; display:flex; gap:8px; flex-wrap:wrap;">
    ...
    <span class="g-tag gray">Busca Semântica Avançada</span>
    <span class="g-tag gray">IA Adaptativa de Alta Precisão</span>
  </div>
</div>
""", unsafe_allow_html=True)
...
st.markdown("""
<div class="g-card">
  <div class="g-label">Como funciona</div>
  ...
  <p style="margin-top:14px; max-width:700px;">
    ...
    um pipeline de inteligência artificial multi-agente, com camadas automáticas de
    verificação e revisão até atingir o padrão de qualidade exigido.
  </p>
  <div class="pipe">
    <div class="pipe-s">📄 Transcrição</div>
    <span class="pipe-arrow">→</span>
    <div class="pipe-s">🤖 IA Multi-Agente</div>
    <span class="pipe-arrow">→</span>
    <div class="pipe-s hl">📐 Diagramas e Documentos Formais</div>
    <span class="pipe-arrow">→</span>
    <div class="pipe-s hl">🧠 Base de Conhecimento</div>
  </div>
  <div class="g3" style="margin-top:28px;">
    ...
    <div class="box gold-b">
      <h3>Output</h3>
      <p>12 artefatos formais persistidos no banco — consultáveis via Assistente
      conversacional com busca e análise cruzada entre reuniões.</p>
    </div>
  </div>
</div>
""", unsafe_allow_html=True)
...
<div class="g-card">
  ...
  <div class="g2" style="margin-top:26px;">
    ...
    <div class="box">
      ...
      Sistema de verificação automática compara múltiplas versões e seleciona a de
      maior qualidade objetiva. Editor visual embutido com histórico de versões e
      persistência no banco.</p>
    </div>
    <div class="box">
...
<div class="g-card">
  ...
  <div class="g3" style="margin-top:24px;">
    <div class="box">
      <h3>📐 BPMN 2.0</h3>
      <p>Diagrama com lanes, gateways e eventos. Visualizador e editor visual embutido.</p>
    </div>
    <div class="box">
    ...
    <div class="box">
      ...
      <p>Entidades, contradições e fatos indexados de múltiplas reuniões — visualização interativa.</p>
    </div>
    <div class="box">
      <h3>💬 Assistente Conversacional</h3>
      <p>Chat inteligente com busca semântica em todo o histórico de reuniões.</p>
    </div>
    <div class="box gold-b">
  ...
  <div class="g2" style="margin-top:24px;">
    ...
    <div>
      ...
      <ul class="check-list">
        ...
        <li>Análise cruzada de múltiplas reuniões via Assistente com busca semântica</li>
        <li>Redução de custos de IA via cache inteligente e cenários por agente</li>
      </ul>
    </div>
  </div>
...
<div class="g-card" style="background:linear-gradient(135deg,#071428 0%,#0B1F3A 60%,#0D1F38 100%);">
  ...
  <div class="g3" style="margin-top:28px;">
    ...
    <div class="box gold-b" style="text-align:center;padding:32px 24px;">
      ...
      e o Assistente fica mais poderoso — seu repositório institucional se constrói sozinho.</p>
    </div>
  </div>
  ...
  <div style="display:flex;gap:12px;flex-wrap:wrap;justify-content:center;margin-top:24px;">
    <span class="g-tag green">Pronto para uso — 100% na nuvem</span>
    <span class="g-tag blue">Busca semântica avançada</span>
    <span class="g-tag gold">Segurança e isolamento por projeto</span>
    <span class="g-tag gray">Multi-tenant</span>
  ...
  <p style="text-align:center;font-size:14px;color:var(--muted);margin-top:24px;">
    pedro.regato@gmail.com &nbsp;·&nbsp; Process2Diagram
  </p>
</div>
""", unsafe_allow_html=True)
