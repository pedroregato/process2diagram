...
│   ├── AtivosDeNegocio.py        # Ativos de Negócio (PC164/165/166/167) — só ativos PROMOVIDOS explicitamente (Artefatos.py + DocumentManager.py); classificação em 3 dimensões (Interesse/Perspectiva/Classificação Formal AN-01..AN-12) + governança (status/tags/owner/notas); toggle de escopo Contexto x Catálogo do Domínio; 6 tipos governáveis (req/BPMN/SBVR termo/SBVR regra/ata/documento) + 4 somente-leitura
