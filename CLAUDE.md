...
│   ├── DocumentManager.py        # Document management — 7 tabs: upload, library, extract artifacts, cross-ref, doc×doc, taxonomy, import spreadsheet
...
│   ├── AtivosDeNegocio.py        # Ativos de Negócio (PC164/165/166) — só ativos PROMOVIDOS explicitamente (Artefatos.py); classificação em 3 dimensões (Interesse/Perspectiva/Classificação Formal AN-01..AN-12) + governança (status/tags/owner/notas); toggle de escopo Contexto x Catálogo do Domínio
